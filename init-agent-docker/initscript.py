...
def check_assigned_request(auth_token,azdo,org,pool_id,max_node):
...
# result = check_assigned_request(auth_token,azdo,org,pool_id,max_node)
# print(result)
# #  uncomment for Testing only 

if __name__ == "__main__":
    if len(sys.argv) != 6:
        print("Usage: python script.py <azdo> <org> <pool_id> <auth_token> <max_node> ")
        sys.exit(1)
